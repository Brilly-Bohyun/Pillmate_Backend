...
public class JwtTokenConst {
    // Token
    public static final Long ACCESS_TOKEN_EXPIRE_TIME = 1000L * 60 * 60 * 24 * 30;        // ACCESS 토큰 만료 시간 (30일)
    public static final Long REFRESH_TOKEN_EXPIRE_TIME = 1000L * 60 * 60 * 24 * 31;   // REFRESH 토큰 만료 시간 (31일)
